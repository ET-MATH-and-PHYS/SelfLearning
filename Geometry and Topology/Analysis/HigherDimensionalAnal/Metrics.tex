...
\begin{eg}[Subsets of Metric Spaces]
...
\begin{eg}[Spaces of Continuous Functions]
...
\begin{lem}[H\"{o}lder's Inequality]
...
\begin{eg}[Doubly recursive sequence in $\R^2$]
...
\begin{eg}[Products of open sets]
...
\begin{namthm}[Bolzano-Weierstrass]
...
\begin{eg}[The Hardy space of the disk]
...
\begin{namthm}[Banach Fixed Point Theorem (or the Contraction Mapping Principle)]
...
\begin{thm}[Picard's Theorem for First Order Differential Equations]
...
\begin{cor}[The Baire Category Theorem]
...
\begin{namthm}[Uniform Boundedness Principal]
...
\begin{defn}[Homeomorphisms and Homeomorphic]
