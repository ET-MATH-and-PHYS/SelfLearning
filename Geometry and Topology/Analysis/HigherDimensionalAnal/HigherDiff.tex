...
\begin{eg}[Affine maps are differentiable]
...
\begin{eg}[Projection maps are Differentiable]
...
\begin{namthm}[Mean value Theorem in Several Variables]
...
\begin{lem}[Key to Inverse Function Theorem]
...
\begin{eg}[Systems of linear equations]
...
\begin{namthm}[Implicit Function Theorem]
