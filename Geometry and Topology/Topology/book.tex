...
\author{E Thompson}
\title{Topology: A Complete Guide}
...
\mainmatter%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{GenTopSps/part}
\include{GenTopSps/TopSps}
\include{GenTopSps/ConnComp}
\include{GenTopSps/Countability}
\include{GenTopSps/Tychonoff}


\include{MetricSps/part}
\include{MetricSps/Metrization}
\include{MetricSps/CompMetric}
\include{MetricSps/BaireSps}
