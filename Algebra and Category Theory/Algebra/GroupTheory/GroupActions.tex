...
\begin{theorem}[Orbit Decomposition Theorem]
...
\begin{theorem}[Cauchy's Theorem]\label{thmname:cauchpthm}
...
\begin{theorem}[Class Equation (Alternate Form)]
...
\begin{theorem}[Sylow's Theorem]\label{thmname:syl}
...
\begin{example}[Groups of order $12$]
...
\begin{example}[Groups of order $p^2q$, $p$ and $q$ distinct primes]
