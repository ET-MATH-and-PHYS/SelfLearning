%%%%%%%%%% Mod Defs %%%%%%%%%%
\chapter{ General Definitions and Examples: Modules}
\label{ModDefs}
% use \chaptermark{}
...
\begin{proposition}[(The Submodule Criterion)]
...
\begin{theorem}[The First Isomorphism Theorem for Modules]\label{thmname:fisomod}
...
\begin{theorem}[The Second Isomorphism Theorem for Modules]\label{thmname:sisomod}
...
\begin{theorem}[The Third Isomorphism Theorem for Modules]\label{thmname:thisomod}
...
\begin{theorem}[The Fourth of Lattice Isomorphism Theorem]\label{thmname:lattisomod}
...
\section{ Free Modules and Generators}
