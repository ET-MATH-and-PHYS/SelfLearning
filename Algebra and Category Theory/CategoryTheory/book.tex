...
\title{Category Theory: A Viewpoint on Math}
...
\mainmatter%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Part/CategoriesFund}
\include{Part/FunctorsAndNats}
\include{Part/Universality}
\include{Part/ConesLimits}
\include{Part/Adjoints}
\include{Part/Monads}
\include{Part/KanExtensions}
